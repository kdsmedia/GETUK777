...
import com.nekgamebling.game.v1.CasinoGameFilter as CasinoGameFilterProto

object CasinoGameFilterProtoMapper {

    fun CasinoGameFilterProto.toDomain(): CasinoGameFilter = CasinoGameFilter(
        query = query,
