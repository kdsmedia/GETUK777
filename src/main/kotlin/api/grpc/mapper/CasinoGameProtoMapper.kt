...
object CasinoGameProtoMapper {
    ...
    /**
     * Converts a [CasinoGame] (and its optional active [CasinoGameVariant]) into the proto DTO.
     * The variant is passed in explicitly because [CasinoGame] is a pure write-side aggregate
     * — it does not carry a back-pointer to its variant.
     */
    fun CasinoGame.toProto(variant: CasinoGameVariant? = null): CasinoGameDto = casinoGameDto {
