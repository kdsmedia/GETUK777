...
/**
 * Recomputes [Game.rtp] = (settled winnings / placed bets) * 100 from the spins
 ...
 */
class RecalculateGameRtpUsecase(
    private val spinRepository: ISpinRepository,
    private val gameRepository: IGameRepository,
) {

    private val logger = LoggerFactory.getLogger(RecalculateGameRtpUsecase::class.java)
    ...
    private fun recalculate(gameSpins: List<Spin>): Game? {
