...
class TongameConfig(config: Map<String, Any>) {
    ...
    /** CasinoProvider REST base URL, e.g. `https://provider.example.com`. Endpoints live under
     *  `<apiUrl>/api/v1/...`. */
    ...
    /** CasinoProvider WebSocket base, e.g. `wss://provider.example.com`. The public jackpot is consumed at
