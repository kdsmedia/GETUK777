...
class FindAllActiveRtpCasinoGameQueryHandler : IQueryHandler<FindAllActiveRtpCasinoGameQuery, Page<CasinoGameView>> {

    override suspend fun handle(query: FindAllActiveRtpCasinoGameQuery): Page<CasinoGameView> = dbRead {
