...
class PlaceSpinCasinoSessionHandler(
...
) : ICommandHandler<PlaceSpinCasinoSessionCommand, PlayerBalance> {

    override suspend fun handle(command: PlaceSpinCasinoSessionCommand): Result<PlayerBalance> = runCatching {
