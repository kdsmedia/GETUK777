...
class RollbackSpinCasinoSessionHandler(
...
) : ICommandHandler<RollbackSpinCasinoSessionCommand, PlayerBalance> {

    override suspend fun handle(command: RollbackSpinCasinoSessionCommand): Result<PlayerBalance> = runCatching {
