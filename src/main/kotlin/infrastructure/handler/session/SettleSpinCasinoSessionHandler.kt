...
class SettleSpinCasinoSessionHandler(
...
) : ICommandHandler<SettleSpinCasinoSessionCommand, PlayerBalance> {

    override suspend fun handle(command: SettleSpinCasinoSessionCommand): Result<PlayerBalance> = runCatching {
        ...
        val externalRoundId = ExternalCasinoRoundId(command.externalRoundId)
        ...
        // See PlaceSpinCasinoSessionHandler: the unique constraint, not the lookup, is what makes a
